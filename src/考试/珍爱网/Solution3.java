...
public class Solution3 {
    ...
    public int calByBackwardNotation(String express) {
        String res = counter(parseToSuffixExpression(expressionToList(express)));
        return Integer.parseInt(res);
    }

    private String counter(List<String> lst) {
    ...
    private String count(String b, String a, char c) {
        if (c == '+') {
