...
public class CompareTest3 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; i++) {
            ...
            time1 += SortTestHelper.testSort2("算法.排序算法.插入类排序.希尔排序.ShellSort", arr1);
            time2 += SortTestHelper.testSort2("算法.排序算法.归并排序.MergeSort", arr2);
            time3 += SortTestHelper.testSort2("算法.排序算法.交换类排序.快速排序.QuickSort", arr3);
            time4 += SortTestHelper.testSort2("算法.排序算法.交换类排序.快速排序.QuickSort2Ways", arr4);
            time5 += SortTestHelper.testSort2("算法.排序算法.交换类排序.快速排序.QuickSort3Ways", arr5);
        }
