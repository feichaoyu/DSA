...
//
//            time1 += SortTestHelper.testSort2("算法.排序算法.归并排序.MergeSort", arr1);
//            time2 += SortTestHelper.testSort2("算法.排序算法.归并排序.MergeSortBU", arr2);
//        }
...
//        System.out.println();
        ...
        for( int i = 0 ; i < T ; i ++ ) {
            ...
            time1 += SortTestHelper.testSort2("算法.排序算法.归并排序.MergeSort3", arr1);
            time2 += SortTestHelper.testSort2("算法.排序算法.归并排序.MergeSortBU", arr2);
        }
